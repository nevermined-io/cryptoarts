                ...
                <div className={styles.headerContent}>
                    <NavLink to="/" className={styles.headerLogo}>
                        <svg className={styles.headerLogoImage} width="550" height="191" viewBox="0 0 550 191" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M184.343 203.548L0 37.131V-131L184.315 35.391V-131L368.657 35.417L549.586 -131V37.131L368.657 203.548L184.343 37.157V203.548Z" fill="url(#paint0_linear)"/>
                            <defs>
